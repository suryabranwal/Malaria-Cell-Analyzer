...
class malaria_classification_completed:
    def malaria_classification_completed(self):
        ##Step1: Load Dataset
        ...
        list1=[ metrics.classification_report(predictions,y_test), model.score(x_test,y_test) ]
        return list1
